...
*/
    ...
    const { createItem, readItem, readOneItem, updateItem, deleteItem } = require('./application.controller');
//
    ...
    class MyRouterClass {
        ...
        routes() {
            ...
            myRouter.post('/', (req, res) => {
                ...
                const { miss, extra, ok } = checkFields( Mandatories.application, req.body );
